        ...
        <div className="formContent">
          <div> 
             <Modal show={showSuccess} onHide={ controlShow}>
                <Modal.Body className="modalSuccess"> 
                  <div> {msgSuccess} <img src={heart} alt="heart" className='heart' /> 
                  </div>  
                </Modal.Body>
            </Modal>
      { show && <Alert variant="danger" className='alerte' > {msg} </Alert> }
     </div>
      ...
      Soins : soins
       ...
       <div className="footerForm">
          ...
          <div className="socialMedia"> 
             <div> <a href='https://www.facebook.com/centredesthetiquelaser' className='links'>  
               <img src={facebook} className="facebookIcon" alt="facebook"/> Centre d'esthétique laser </a> 
             </div>
             <div> <a href='https://www.instagram.com/centrelaseresthetique/' className='links'>  
               <img src={instagram} className="instagramIcon" alt="insta" /> centrelaseresthetique </a> 
             </div>
          </div>
        </div>
      </div>
